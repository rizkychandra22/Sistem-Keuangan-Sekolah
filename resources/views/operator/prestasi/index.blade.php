...
@section('title', 'Data Prestasi SDN Caringin Ngumbang')
...
@section('content')
    <div class="container">
        ...
        <div class="table-responsive">
            <table id="tablePrestasi" class="table table-bordered table-hover table-striped">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nama</th>
                ...
                $('#tablePrestasi').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            name: 'gambar',
                            render: function (data, type, row) {
                                let photoUrl = `/images/prestasi/${data}`;
                        ...
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                let editUrl = `{{ route('prestasi.edit', ':id') }}`.replace(':id', row.id);
                                let deleteUrl = `{{ route('prestasi.destroy', ':id') }}`.replace(':id', row.id);
        ...
        <script>
            function confirmDelete(id, judul, deskripsi, deleteUrl) {
                Swal.fire({
                    ...
                    text: `Data prestasi dengan judul ${judul} akan dihapus.`,
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire({
                                    title: 'Dihapus!',
                                    text: `Data prestasi dengan judul ${judul} berhasil dihapus.`,
                                    icon: 'success',
                            ...
                            error: function(xhr) {
                                Swal.fire({
                                    title: 'Error!',
                                    text: `Terjadi kesalahan saat menghapus data prestasi ${judul}.`,
                                    icon: 'error',
