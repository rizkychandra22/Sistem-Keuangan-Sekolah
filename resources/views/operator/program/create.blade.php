...
@section('title', 'Tambah Data Program Kerja SDN Caringin Ngumbang')
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="judul" class="form-control" placeholder="Nama program kerja">
                        @error('judul')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <textarea type="text" name="deskripsi" class="form-control" placeholder="Deskripsi program kerja"></textarea>
                        @error('deskripsi')
                            <small style="color:red">{{$message}}</small>
                        @enderror
                    </div>
