...
@section('title', 'Data Album Lomba SDN Caringin Ngumbang')
                ...
                $('#tableLomba').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            name: 'gambar',
                            render: function (data, type, row) {
                                let photoUrl = `/images/gallery/lomba/${data}`;
                        ...
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                let editUrl = `{{ route('gallery-lomba.edit', ':id') }}`.replace(':id', row.id);
                                let deleteUrl = `{{ route('gallery-lomba.destroy', ':id') }}`.replace(':id', row.id);
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire({
                                    ...
                                    $('#tableLomba').DataTable().ajax.reload();
                                });
                            },
                            error: function(xhr) {
                                Swal.fire({
