...
@section('title', 'Tambah Data Album Perpisahan SDN Caringin Ngumbang')
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Tema kegiatan perpisahan">
                        @error('title')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="subtitle" class="form-control" placeholder="Deskripsi kegiatan perpisahan">
                        @error('subtitle')
                            <small style="color:red">{{$message}}</small>
                        @enderror
                    </div>
