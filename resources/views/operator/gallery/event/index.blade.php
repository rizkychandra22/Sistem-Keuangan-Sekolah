...
@section('title', 'Data Album Event SDN Caringin Ngumbang')
...
@section('content')
    <div class="container">
        ...
        <div class="table-responsive">
            <table id="tableEvent" class="table table-bordered table-hover table-striped">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nama</th>
                ...
                $('#tableEvent').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            name: 'gambar',
                            render: function (data, type, row) {
                                let photoUrl = `/images/gallery/event/${data}`;
                        ...
                        },
                        {
                            data: null,
                            render: function (data, type, row) {
                                let editUrl = `{{ route('gallery-event.edit', ':id') }}`.replace(':id', row.id);
                                let deleteUrl = `{{ route('gallery-event.destroy', ':id') }}`.replace(':id', row.id);
