...
@section('title', 'Tambah Dana Pengeluaran')
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <textarea type="text" name="keterangan" class="form-control" placeholder="Deskripsi pengeluaran"></textarea>
                        @error('keterangan')
                            <small style="color:red">{{$message}}</small>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="number" id="jumlahInput" name="jumlah" class="form-control" placeholder="Jumlah nominal yang dikeluarkan">
                        @error('jumlah')
                            <small style="color:red">{{$message}}</small>
                        @enderror
                    </div>
