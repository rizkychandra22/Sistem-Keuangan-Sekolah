...
@section('title', 'Rekapitulasi Pemasukan Sekolah')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <a id="exportExcel" class="btn btn-success btn-sm mb-1 mr-2 disabled" href="#">Eksport pemasukan (Excel)</a>
                <a id="exportPdf" class="btn btn-danger btn-sm mb-1 disabled mr-2" href="#">Eksport pemasukan (PDF)</a>
            </div>
        </div>
        
        <div class="table-responsive">
            <table id="laporanPemasukan" class="table table-bordered table-hover table-striped"></table>
        </div>
    </div>
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function () {
                ...
                var table = $('#laporanPemasukan').DataTable({
                    serverSide: true,
                    responsive: true,
                    processing: true,
                    ajax: {
                        url: "{{ route('rekap.pemasukan') }}",  
                        type: 'GET',
                        data: function(d) {
                ...
                $('#filterButton').on('click', function() {
                    ...
                    if (isValid) {
                        ...
                        var pdfUrl = "{{ route('pemasukan.export.pdf') }}?start_date=" + startDate + "&end_date=" + endDate;
                        var excelUrl = "{{ route('pemasukan.export.excel') }}?start_date=" + startDate + "&end_date=" + endDate;
