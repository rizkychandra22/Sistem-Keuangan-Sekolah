            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $mapel->nama) }}" class="form-control" placeholder="Nama Mata Pelajaran" required>
                        @error('nama')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="kode" value="{{ old('kode', $mapel->kode) }}" class="form-control" placeholder="Kode Mata Pelajaran" required>
                        @error('kode')
                            <small style="color:red">{{ $message }}</small>
                        @enderror
                    </div>
