...
@section('title', 'Tambah Data Rombel Sekolah')
            ...
            <div class="row">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="paralel" id="paralel" value="{{ old('paralel') }}" class="form-control" placeholder="Contoh: A / B / C / D">
                        @error('paralel')
                            <small style="color:red">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="kapasitas" value="{{ old('kapasitas', 20) }}" class="form-control" placeholder="Kapasitas Siswa">
                        @error('kapasitas')
                            <small style="color:red">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                @include('components.admin-form-actions', ['cancelRoute' => route('rombel.index')])
            </div>
        </form>
    </div>
